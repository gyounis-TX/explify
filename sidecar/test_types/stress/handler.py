    ...
    def get_prompt_context(self, extraction_result: ExtractionResult | None = None) -> dict:
        ...
        if subtype_id == "exercise_treadmill_test":
            ...
            base["explanation_style"] = (
                ...
                "Explain what the results mean for the patient's heart health.\n"
                "IMPORTANT pharmacological stress rules:\n"
                "- Do NOT discuss the patient's ability to reach target heart "
                "rate. The usual heart rate analysis that applies to physical "
                "exercise tests does NOT apply to pharmacologic stress tests "
                "in the same way. Do NOT comment on target heart rate, "
                "predicted maximum heart rate, or % of max predicted heart "
                "rate.\n"
                "- Do NOT state that the heart rate response may limit "
                "interpretation of the EKG stress test. That caveat only "
                "applies to exercise-based tests.\n"
                "- Focus on wall motion findings, EF change, and overall "
                "interpretation."
            )
            base["interpretation_rules"] = (
                ...
                "4. Do NOT discuss target heart rate or % of max predicted "
                "heart rate — pharmacologic stress test heart rate analysis "
                "does not apply in the same way as exercise tests.\n"
